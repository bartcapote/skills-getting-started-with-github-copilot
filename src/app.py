...
activities = {
    ...
    "Soccer Team": {
        "description": "Training and matches for students interested in soccer and teamwork",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18, 
        "participants": ["liam@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice shooting, drills, and friendly scrimmages",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu"]
    },
    "Drama Club": {
        "description": "Act, perform, and explore stage production and character development",
